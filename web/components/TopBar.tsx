...
export default function TopBar() {
  ...
  useEffect(() => {
    ...
    function onStorage(e: StorageEvent) {
      if (e.key === 'ctrlr-theme' && e.newValue && THEMES[e.newValue]) {
  ...
  return (
    <div className="fixed top-0 left-0 right-0 z-50 flex items-stretch font-mono overflow-hidden" style={{ background: PAGE_BG, height: BAR_H }}>
      {LABELS.map((label, i) => {
